...
//             GameEngine engine = new(mSoundManager, mMessageManager);
// 
...
//             GameGlobals.DebugSystem.ShowRenderInfo(mTextureManager,GameGlobals.Camera.Zoom, GameGlobals.WorldMousePosition);
//             spriteBatch.End();
//         }
// 
...
// 
//             mMessageManager.Update(inputState, .GameTime);
//             mGameTimeText.Text = MyUtility.ConvertSecondsToGameTimeUnits(0);
...
//             mDeselectButton.Disabled = true; GameGlobals.SelectObject == null;
