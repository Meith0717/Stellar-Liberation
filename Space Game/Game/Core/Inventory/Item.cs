...
namespace CelestialOdyssey.Game.Core.Inventory
{
    ...
    {
        public Postyum(Vector2 dropPosition) : base(dropPosition, "postyum") { }
    }

    public class Odyssyum : Item 
    {
        public Odyssyum(Vector2 dropPosition) : base(dropPosition, "odyssyum") { }
    }
    ...
    public class Item : GameObject
    {
        ...
        public Item(Vector2 position, string textureId) 
