...
namespace StellarLiberation.Game.GameObjects.Recources.Weapons
{
    public class Weapon : Item
    {
        ...
        public void Fire(GameLayer gameLayer, Spaceship target)
            => gameLayer.GameObjects.Add(new WeaponProjectile(mPosition, mRotation, mSpaceship, target, HullDamage, ShieldDamage, mProjectileFollowTarget, mProjectileTextureID, mProjectileColor));
