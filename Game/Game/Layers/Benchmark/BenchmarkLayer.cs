...
namespace StellarLiberation.Game.Layers.Benchmark
{
    internal class BenchmarkLayer : GameLayer
    {
        ...
        public override void Draw(SpriteBatch spriteBatch)
        {
            ...
            mDataCollector.AddData([mFrameCounter.CurrentFramesPerSecond, SpatialHashing.Count, mFrameCounter.CurrentFramesPerSecond, ParticleManager.GameObjects2Ds.Count]);
